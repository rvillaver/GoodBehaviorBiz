...
**A memory retires when it stops being true or is superseded, never because the issue it described was fixed.** Keep the index to one line per live memory; **archive/collapse stale memories only when their replacement is clear.**
